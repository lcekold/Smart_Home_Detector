...
#include <memory>
#include "../../Smart_Home_Detector/serialworker.h"
...
QT_MOC_LITERAL(4, 28, 8), // "DataView"
QT_MOC_LITERAL(5, 37, 4), // "temp"
QT_MOC_LITERAL(6, 42, 4), // "humi"
QT_MOC_LITERAL(7, 47, 5), // "Light"
QT_MOC_LITERAL(8, 53, 5), // "start"
QT_MOC_LITERAL(9, 59, 4), // "stop"
QT_MOC_LITERAL(10, 64, 8), // "readData"
QT_MOC_LITERAL(11, 73, 8), // "SendData"
QT_MOC_LITERAL(12, 82, 34) // "slot_serialport_delay_recv_ti..."

    },
    "SerialWorker\0ReadData\0\0data\0DataView\0"
    "temp\0humi\0Light\0start\0stop\0readData\0"
    "SendData\0slot_serialport_delay_recv_timeout"
};
...
void SerialWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->DataView((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3]))); break;
        case 2: { bool _r = _t->start();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->stop(); break;
        case 4: _t->readData(); break;
        case 5: _t->SendData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->slot_serialport_delay_recv_timeout(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SerialWorker::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialWorker::ReadData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SerialWorker::*)(double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialWorker::DataView)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialWorker::ReadData(QByteArray _t1)
{
...
// SIGNAL 1
void SerialWorker::DataView(double _t1, double _t2, double _t3)
{
